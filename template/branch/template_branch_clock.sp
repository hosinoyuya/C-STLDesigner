****************************** STL Designer 2 branch for clock Template ver 2.3 ******************************

*** Notice *** ------------------------------------------------------*
* 栗原（2013年度修士卒）が設計した，分岐配線系のクロック整形用テンプレート
* 主配線のみ分割します．
...
Vs1	101	0 PWL(
.INCLUDE ./data/input_data/250MHz-clk-3.3V )
...
W2		104	0	optpt1	0	RLGCMODEL=Z50	N=1	L=220m
C1		optpt1	0	7p

W3_STL_6	104	0	106	0	RLGCMODEL=Z50	N=1	L=240m

W4		106	0	107	0	RLGCMODEL=Z50	N=1	L=220m
C2		107	0	7p
