******************************** STL Designer 2 branch Template ver 2.3 ********************************

*** Notice *** ------------------------------------------------------*
* 栗原（2013年度修士卒）が設計した，分岐配線系のテンプレート
* 主配線及び分岐配線を全て分割します．
...
Vs1	101	0 PWL(
.INCLUDE ./data/input_data/500Mbps-3.3V-koritsuha-2 )

Ron1     101         102         20
RD1      102         103         30

W1_STL_5	103	0	104	0	RLGCMODEL=Z50	N=1	L=200m

W2_STL_5	104	0	optpt1	0	RLGCMODEL=Z50	N=1	L=220m
C1		optpt1	0	7p

W3_STL_6	104	0	106	0	RLGCMODEL=Z50	N=1	L=240m

W4_STL_5	106	0	107	0	RLGCMODEL=Z50	N=1	L=220m
C2		107	0	7p

W5_STL_4	106	0	108	0	RLGCMODEL=Z50	N=1	L=160m
...
Ron1000		1001	1002	20
Rd1000		1002	1003	30

T1001		1003	0	vspt1	0	Z0=50	TD=2649.36p
T1002		vspt1	0	1005	0	Z0=50	TD=1513.92p
T1003		1005	0	1006	0	Z0=50	TD=1009.28p
